...
* In [creative fields]{.alert}, AI is often viewed with skepticism.    
    - E.g. because it may raise doubts about one’s own abilities or motivation.
...
* [Six resulting treatments]{.alert}:
...
::: {.column width="25%"}
[RO_AItask]{.treatment} <br>
[RO_noAItask]{.treatment}
:::

::: {.column width="38%"}
[CR_AItask_Humeval]{.treatment} <br>
[CR_noAItask_Humeval]{.treatment}
:::

::: {.column width="33%"}
[CR_AItask_AIeval]{.treatment} <br>
[CR_noAItask_AIeval]{.treatment}
:::
...
* Conditions [RO_AItask]{.treatment} and [CR_AItask]{.treatment}: workers can interact with a GPT-based chatbot that helps them complete the task. 

* Conditions [RO_noAItask]{.treatment} and [CR_noAItask]{.treatment}: no chatbot  is provided.
...
* [Controls:]{.alert}    
    4. Robustness check: [exclusion of observations]{.alert} in the left tail of the completion time distribution in condition [noAItask]{.treatment} (i.e. workers with suspiciously low completion times).
